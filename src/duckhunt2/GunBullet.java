...
/**
 * A gun bullet in the game
 * 
 * @author Thomas Ejnefj�ll
 */
public class GunBullet implements GameObject {
	 ...
	 */
	public GunBullet(Image missImage, Image hitImage, int x, int y, int timeToLive) {
		mImage = missImage;
		mHitImage = hitImage;
		mX = x;
		mY = y;		
	...
	@Override
	public Area getArea() {		
		return new Area(new Ellipse2D.Double(mX, mY, getWidth(), getHeight()));
	}
}